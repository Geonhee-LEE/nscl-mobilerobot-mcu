...
#include "../../include/nscl/nscl_sensor.h"

NSCLSensor::NSCLSensor()
{
}
...
void NSCLSensor::initIMU(void)
{
  imu_.begin();
}

void NSCLSensor::updateIMU(void)
{
  imu_.update();
}

void NSCLSensor::calibrationGyro()
{
  uint32_t pre_time;
  uint32_t t_time;
...
sensor_msgs::Imu NSCLSensor::getIMU(void)
{
...
float* NSCLSensor::getOrientation(void)
{
...
sensor_msgs::MagneticField NSCLSensor::getMag(void)
{
...
float NSCLSensor::checkVoltage(void)
{
  float vol_value;
...
uint8_t NSCLSensor::checkPushButton(void)
{
